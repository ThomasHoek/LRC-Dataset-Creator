...
os.makedirs(f'Results/{dataset}/prolog_{model}_lem_verb/', exist_ok=True)
final.to_csv(f'Results/{dataset}/prolog_{model}_lem_verb/{dataset}_{part}.pl', sep='\n', index=False, header=False)
# break
