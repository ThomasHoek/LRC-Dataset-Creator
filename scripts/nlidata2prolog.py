...
def parse_arguments():
    ...
    parser = argparse.ArgumentParser(
        description="Extract sentences per line for parsing"
    )
    ...
    parser.add_argument(
        "--corpus",
        required=True,
        choices=["sick_semeval", "snlijson", "PPDB", "test"],
        help="Corpus to be converted",
    )
    parser.add_argument(
        "--tokenize",
        default="nltk",
        choices=["raw", "nltk", "nltk_apo", "spacy", "native"],
